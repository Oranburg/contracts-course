const EXERCISE = {
  "slug": "minas-tirith-performance",
  "title": "Minas Tirith Performance — Substantial Performance",
  "description": "R2d § 241 balancing with scales of justice.",
  "kicker": "Module 6a • Substantial Performance",
  ...
  "tome": [
    ...
    "Casebook: economic waste reasoning favors diminution-in-value over destructive completion costs in Jacob & Youngs settings."
  ],
  "artifacts": [
    {
      "id": "architect",
      "name": "Architect Report",
      "text": "\"Structural integrity is fully intact.\""
    },
    {
      "id": "estimate",
      "name": "Demolition Estimate",
      "text": "\"Replace stone by teardown/rebuild: 60,000 silver.\""
    },
    {
      "id": "valuation",
      "name": "Valuation Memo",
      "text": "\"Diminution in market value: 0.\""
    }
  ],
  "steps": [
    {
      "type": "desk",
      "irac": "Facts",
      "prompt": "Read all records before balancing materiality."
    },
    {
      "type": "scales",
      "irac": "Rule + Application",
      "prompt": "Check all proven factors and lock the balancing test.",
      "factors": [
        {
          "id": "venial",
          "label": "Venial fault (not willful substitution)"
        },
        {
          "id": "integrity",
          "label": "Structural integrity intact"
        },
        {
          "id": "waste",
          "label": "Demolition would create economic waste"
        }
      ],
      "required": [
        "venial",
      ...
      "success": "Scale tips to substantial performance (minor breach).",
      "failure": "Select all proven § 241-style factors to complete the balance."
    },
    {
      "type": "mcq",
      "irac": "Conclusion",
      "prompt": "Best damages result?",
      "options": [
        {
          "text": "Contract price minus zero diminution in value.",
          "correct": true,
          "feedback": "Correct. Casebook economic-waste framing points away from costly demolition."
        },
        {
          "text": "Automatic 60,000 completion cost award.",
          "correct": false,
          "feedback": "That remedy would produce the waste Jacob & Youngs warns against."
        },
        {
          "text": "Owner pays nothing due to strict literalism.",
          "correct": false,
          "feedback": "Balancing factors show substantial performance, not total forfeiture."
        }
      ]
    }
  ]
