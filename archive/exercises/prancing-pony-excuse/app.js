const EXERCISE = {
  "slug": "prancing-pony-excuse",
  "title": "Prancing Pony Excuse — Frustration of Purpose",
  "description": "R2d § 265 / Krell v. Henry exercise.",
  "kicker": "Module 6b • Excuse",
  "subtitle": "The Prancing Pony",
  "law": "R2d § 265 (Frustration of Purpose)",
  "narrative": "Room rented to view a parade. Nazgûl attack and parade is canceled. Occupying room is still possible, but the contract's purpose is gone.",
  "image": "https://github.com/user-attachments/assets/1c64d3d6-7814-41d9-a735-6730289b27ab",
  "tome": [
    "R2d § 265: duty is discharged when principal purpose is substantially frustrated by an event whose non-occurrence was a basic assumption.",
    "Casebook on Krell v. Henry: performance may remain possible while purpose is destroyed.",
    "Casebook: frustration doctrine addresses defeated purpose, not literal impossibility."
  ],
  "artifacts": [
    {
      "id": "rental",
      "name": "Rental Scroll",
      "text": "\"Premium balcony room\" reserved for parade day."
    },
    {
      "id": "flyer",
      "name": "Town Crier Flyer",
      "text": "\"Best parade view from the Prancing Pony balconies!\""
    },
    {
      "id": "notice",
      "name": "Emergency Notice",
      "text": "\"Parade canceled after Nazgûl attack.\""
    }
  ],
  "steps": [
    {
      "type": "desk",
      "irac": "Facts",
      "prompt": "Examine all artifacts for the shared basic assumption."
    },
    {
      "type": "mcq",
      "irac": "Issue",
      "prompt": "Which doctrine best applies?",
      "options": [
        {
          "text": "Frustration of purpose under § 265.",
          "correct": true,
          "feedback": "Correct. Casebook: in Krell-like facts, purpose fails although occupancy remains possible."
        },
        {
          "text": "Impossibility only.",
          "correct": false,
          "feedback": "Room use was still physically possible, so impossibility is not the best fit."
        },
        {
          "text": "No excuse doctrine.",
          "correct": false,
          "feedback": "The parade cancellation defeats the principal contractual purpose."
        }
      ]
    },
    {
      "type": "mcq",
      "irac": "Application",
      "prompt": "What proves the principal purpose was a basic assumption?",
      "options": [
        {
          "text": "The Town Crier Flyer tying balcony rentals to parade viewing.",
          "correct": true,
          "feedback": "Yes. It shows both sides understood parade viewing as central."
        },
        {
          "text": "The room key alone.",
          "correct": false,
          "feedback": "A key proves access, not the contract's shared purpose."
        },
        {
          "text": "The emergency notice alone.",
          "correct": false,
          "feedback": "Cancellation matters, but shared purpose is shown most clearly by pre-contract flyer context."
        }
      ]
    },
    {
      "type": "info",
      "irac": "Conclusion",
      "prompt": "Holding: performance is excused under § 265 because the principal purpose was substantially frustrated."
    }
  ]
};
...
function renderSummary(){
  if(typeof KSync!=="undefined")KSync.complete({exerciseId:"prancing-pony-excuse",exerciseTitle:"Prancing Pony Excuse",chapterNum:6,score:state.score,total:state.total,mastery:state.mastery});
