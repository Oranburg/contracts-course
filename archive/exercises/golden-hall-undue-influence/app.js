const EXERCISE = {
  "slug": "golden-hall-undue-influence",
  "title": "Golden Hall — Undue Influence",
  "description": "R2d § 177 objection mechanic exercise.",
  "kicker": "Module 4b • Undue Influence",
  "subtitle": "The Golden Hall of Rohan",
  "law": "R2d § 177",
  "narrative": "Gríma pressures a weakened King Théoden into a one-sided grain contract and claims the king signed willingly.",
  "image": "https://github.com/user-attachments/assets/fe4c0134-004e-4aad-98b7-eefcd126c6c9",
  "tome": [
    "R2d § 177: unfair persuasion by one who dominates the victim or occupies a trust relationship makes contract voidable.",
    "Casebook: \"Undue influence occurs when a party's will is overborne by excessive persuasion.\"",
    "Casebook: unlike duress, undue influence does not require physical force or explicit threats."
  ],
  "artifacts": [
    {
      "id": "contract",
      "name": "Grain Contract",
      "text": "Exclusive grain rights at sharply one-sided prices."
    },
    {
      "id": "healer",
      "name": "Healer Note",
      "text": "\"King is weakened and dependent this fortnight.\""
    },
    {
      "id": "guard",
      "name": "Guard Statement",
      "text": "\"Gríma blocked outside advisors and insisted on immediate signature.\""
    }
  ],
  "steps": [
    {
      "type": "desk",
      "irac": "Facts",
      "prompt": "Open each artifact to build the domination/persuasion record."
    },
    {
      "type": "objection",
      "irac": "Objection!",
      "prompt": "Objection! \"The King signed willingly, so the contract must stand.\"",
      "options": [
        {
          "text": "Overrule under R2d § 177 (undue influence).",
          "correct": true,
          "feedback": "Correct. Casebook: undue influence turns on domination and excessive persuasion, not physical force."
        },
        {
          "text": "Sustain; absent physical threat there is no defense.",
          "correct": false,
          "feedback": "Incorrect. Undue influence can void assent without physical compulsion."
        }
      ]
    },
    {
      "type": "mcq",
      "irac": "Conclusion",
      "prompt": "Best doctrinal result?",
      "options": [
        {
          "text": "Contract is voidable for undue influence.",
          "correct": true,
          "feedback": "Yes. § 177 supports rescission when independent judgment is supplanted."
        },
        {
          "text": "Contract is automatically enforceable.",
          "correct": false,
          "feedback": "Not where unfair persuasion under domination is shown."
        },
        {
          "text": "Only duress can apply.",
          "correct": false,
          "feedback": "Facts better match undue influence than threat-based duress."
        }
      ]
    }
  ]
...
function renderSummary(){
  if(typeof KSync!=="undefined")KSync.complete({exerciseId:"golden-hall-undue-influence",exerciseTitle:"Golden Hall Undue Influence",chapterNum:5,score:state.score,total:state.total,mastery:state.mastery});
