const EXERCISE = {
  "slug": "bree-acceptance",
  "title": "Bree Acceptance — Bilateral vs. Unilateral",
  "description": "R2d § 50 manner of acceptance exercise in Bree.",
  "kicker": "Module 2 • Bilateral vs. Unilateral",
  "subtitle": "Bree Reward Notice",
  "law": "R2d § 50(1) (Manner of Acceptance)",
  "narrative": "Barliman offers a reward for lost keys. Bill Ferny promises to find them. Strider actually finds and returns them.",
  "image": "https://github.com/user-attachments/assets/876e03a8-5bdb-4b04-abe1-e4b0756d4588",
  "tome": [
    "R2d § 50: acceptance by performance requires completing invited performance.",
    "Casebook: \"A unilateral contract cannot ... be accepted by promising to perform.\"",
    "Casebook: \"The only way to accept ... is to do the requested performance.\""
  ],
  "artifacts": [
    {
      "id": "notice",
      "name": "Reward Notice",
      "text": "\"Reward paid to whoever returns the inn keys.\""
    },
    {
      "id": "nob",
      "name": "Nob Witness Statement",
      "text": "\"Bill only talked. Strider acted.\""
    },
    {
      "id": "ring",
      "name": "Recovered Key Ring",
      "text": "Delivered by Strider to the inn counter."
    }
  ],
  "steps": [
    {
      "type": "desk",
      "irac": "Facts",
      "prompt": "Review all evidence on the desk."
    },
    {
      "type": "dragdrop",
      "irac": "Issue",
      "prompt": "Drag each character to the correct doctrinal role buckets.",
      "tokens": [
        {
          "id": "barliman",
          "label": "Barliman"
      ...
      "buckets": [
        ...
        {
          "id": "performing",
          "label": "Performing Offeree"
        },
        {
          "id": "ineffectual",
          "label": "Ineffectual Offeree"
        }
      ],
      "requiredAssignments": {
        "barliman": "offeror",
      ...
      "success": "Correct mapping. Casebook: unilateral offers are accepted only by completed performance.",
      "failure": "Re-map roles to match unilateral acceptance doctrine."
    },
    {
      "type": "mcq",
      "irac": "Conclusion",
      "prompt": "Who accepted the unilateral offer?",
      "options": [
        {
          "text": "Strider, by performance.",
          "correct": true,
          "feedback": "Correct. Casebook: \"The only way to accept ... is to do the requested performance.\""
        },
        {
          "text": "Bill Ferny, by promising.",
          "correct": false,
          "feedback": "No. A return promise does not accept a unilateral offer."
        },
        {
          "text": "Both Bill and Strider.",
          "correct": false,
          "feedback": "Only completed performance accepts this reward offer."
        }
      ]
    }
  ]
...
function renderSummary(){
  if(typeof KSync!=="undefined")KSync.complete({exerciseId:"bree-acceptance",exerciseTitle:"Bree Acceptance",chapterNum:2,score:state.score,total:state.total,mastery:state.mastery});
