const EXERCISE = {
  "slug": "moria-interpretation",
  "title": "Moria Interpretation — Latent Ambiguity",
  "description": "UCC § 1-303 hierarchy exercise.",
  "kicker": "Module 5 • Interpretation",
  "subtitle": "Moria Border Outpost",
  "law": "UCC § 1-303",
  "narrative": "Contract says \"precious metal.\" Dwarves deliver silver; Elves expected Mithril based on 50 prior Mithril deliveries.",
  "image": "https://github.com/user-attachments/assets/876e03a8-5bdb-4b04-abe1-e4b0756d4588",
  "tome": [
    "UCC § 1-303: course of dealing and usage of trade inform meaning.",
    "Casebook: latent ambiguity appears when a facially clear term becomes unclear in context.",
    "Casebook: prior dealings can supply the parties' common basis of understanding."
  ],
  "artifacts": [
    {
      "id": "guild",
      "name": "Elven Guild Manual",
      "text": "Trade usage: \"precious metal\" often means gold/silver."
    },
    {
      "id": "ledger",
      "name": "Century Ledger",
      "text": "50 prior deliveries from Dwarves to Elves: each listed as Mithril."
    },
    {
      "id": "dispatch",
      "name": "Port Dispatch",
      "text": "Latest shipment marked \"precious metal\" only."
    }
  ],
  "steps": [
    {
      "type": "desk",
      "irac": "Facts",
      "prompt": "Review all evidence sources before interpretation."
    },
    {
      "type": "redline",
      "irac": "Issue",
      "prompt": "Identify the phrase that carries latent ambiguity.",
      "docText": "Seller agrees to deliver 1,000 pounds of precious metal to Buyer.",
      "target": "precious metal",
      "success": "Correct. Latent ambiguity appears when this phrase is applied to extrinsic context."
    },
    {
      "type": "mcq",
      "irac": "Rule + Application",
      "prompt": "Which evidence controls here?",
      "options": [
        {
          "text": "Course of dealing (50 Mithril deliveries) controls over general trade usage.",
          "correct": true,
          "feedback": "Correct. Repeated prior performance supplies the strongest shared meaning here."
        },
        {
          "text": "Trade usage always defeats course of dealing.",
          "correct": false,
          "feedback": "No. Casebook treatment gives strong weight to repeated dealings."
        },
        {
          "text": "No ambiguity exists because silver is valuable.",
          "correct": false,
          "feedback": "Value does not resolve which metal the parties meant in context."
        }
      ]
    },
    {
      "type": "info",
      "irac": "Conclusion",
      "prompt": "Holding: the Elves prevail because course of dealing establishes Mithril as the contractual meaning of \"precious metal.\""
    }
  ]
};
...
function renderSummary(){
  if(typeof KSync!=="undefined")KSync.complete({exerciseId:"moria-interpretation",exerciseTitle:"Moria Interpretation",chapterNum:3,score:state.score,total:state.total,mastery:state.mastery});
