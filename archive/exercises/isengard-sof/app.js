...
function renderSummary(){
  if(typeof KSync!=="undefined")KSync.complete({exerciseId:"isengard-sof",exerciseTitle:"Isengard Statute of Frauds",chapterNum:4,score:state.score,total:state.total,mastery:state.mastery});
